 ...
 * (Internal helper function, doesn't need export)
 */
function handleColorChange() { // <-- DEFINED ONCE HERE
 ...
 */
function populateCustomTypeList() { // <-- DEFINED ONCE HERE
 ...
 * (Internal helper function)
 */
function handleEditCustomTypeClick(event) { // <-- DEFINED ONCE HERE
 ...
 * (Internal helper function)
 */
async function handleDeleteCustomTypeClick(event) { // <-- DEFINED ONCE HERE
    const typeId = event.target.dataset.id;
 ...
 * (Internal helper function)
 */
async function handleSaveEnergyType() { // <-- DEFINED ONCE HERE
 ...
 * (Internal helper function)
 */
async function refreshDataAndUI() { // <-- DEFINED ONCE HERE
...
// NOTE: Ensure internal helper functions (clearAdminEnergyForm, handleColorChange, etc.)
// are defined ONLY ONCE, as shown above.
